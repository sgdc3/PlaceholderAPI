...
public class HeroesHook extends IPlaceholderHook {

	PlaceholderAPIPlugin plugin;
	
	private Heroes heroes = null;
	
	public HeroesHook(InternalHook hook) {
		super(hook);
	}
	...
	public boolean hook() {
		...
		heroes = (Heroes) Bukkit.getPluginManager().getPlugin(getPlugin());
