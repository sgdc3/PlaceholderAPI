...
public class SimpleClansHook {
	...
	public SimpleClansHook(PlaceholderAPIPlugin i) {
		plugin = i;
	}
	...
	public void hook() {
		...
		if (Bukkit.getPluginManager().isPluginEnabled("SimpleClans")) {
			...
			SimpleClans clans = (SimpleClans) Bukkit.getPluginManager().getPlugin("SimpleClans");
			...
			if (clans != null) {
				...
				if (clanManager != null) {
					...
					boolean hooked = PlaceholderAPI.registerPlaceholderHook(clans, new PlaceholderHook() {
