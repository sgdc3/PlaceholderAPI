...
public class Statistic_1_8_R1_Placeholders extends IPlaceholderHook implements VersionSpecific {

	public Statistic_1_8_R1_Placeholders(InternalHook hook) {
		super(hook);
	}
	...
	public NMSVersion getVersion() {
		return NMSVersion.SPIGOT_1_8_R1;
	}
