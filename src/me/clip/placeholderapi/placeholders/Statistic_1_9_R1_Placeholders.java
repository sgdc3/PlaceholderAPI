...
public class Statistic_1_9_R1_Placeholders extends IPlaceholderHook implements VersionSpecific {
	
	public Statistic_1_9_R1_Placeholders(InternalHook hook) {
		super(hook);
	}
	...
	public String onPlaceholderRequest(Player p, String identifier) {
		...
		case "sleep_in_bed":
			return String.valueOf(p.getStatistic(Statistic.SLEEP_IN_BED));
		case "sneak_time":
			return String.valueOf(p.getStatistic(Statistic.SNEAK_TIME));
		case "aviate_one_cm":
			return String.valueOf(p.getStatistic(Statistic.AVIATE_ONE_CM));
		case "ticks_played":
		...
		case "pickup":
			return String.valueOf(Statistic.PICKUP);
		case "pig_one_cm":
