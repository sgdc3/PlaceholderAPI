...
public class Statistic_1_7_R4_Placeholders extends IPlaceholderHook implements VersionSpecific {
	

	public Statistic_1_7_R4_Placeholders(InternalHook hook) {
		super(hook);
	}
	...
	public NMSVersion getVersion() {
		return NMSVersion.SPIGOT_1_7_R4;
	}
}
